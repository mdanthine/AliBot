...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        const embed = new EmbedBuilder()
            .setTitle("Current year election chart")
        ...
        const currentCandidatesButton = new ButtonBuilder()
            .setCustomId('current-candidates-list')
            .setLabel('Current Candidates List')
            .setStyle(ButtonStyle.Primary)   

        const row = new ActionRowBuilder().addComponents(currentMayorButton, lastElectionButton, currentCandidatesButton);
